...
Open http://127.0.0.1:3000. Without a Google Maps key, the bundled offline campus map is used automatically. Scenario state is held in memory and resets when the page reloads. Export a run to keep its parameters and results.
